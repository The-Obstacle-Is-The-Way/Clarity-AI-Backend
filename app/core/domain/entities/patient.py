...
class Patient(BaseModel):
    ...
    user_id: uuid.UUID | None = Field(None, description="Associated user account ID") # Added user_id
    ...
    sex_at_birth: str | None = Field(None, description="Patient's sex assigned at birth") # Consider enum if appropriate
    ...
    contact_info: ContactInfo = Field(default_factory=ContactInfo, description="Detailed contact information object")
    emergency_contact: EmergencyContact | None = Field(None, description="Patient's emergency contact")
    ...
    religion_spirituality: str | None = Field(None, description="Patient's religion or spirituality")
    ...
    medical_record_number_lve: str | None = Field(None, description="Patient's Medical Record Number")
    social_security_number_lve: str | None = Field(None, description="Patient's Social Security Number")
    drivers_license_number_lve: str | None = Field(None, description="Patient's Driver's License Number")
    insurance_policy_number_lve: str | None = Field(None, description="Patient's Insurance Policy Number")
    insurance_group_number_lve: str | None = Field(None, description="Patient's Insurance Group Number")
    ...
    medical_history: list[str] = Field(default_factory=list, description="List of medical conditions or history items")
    medications: list[dict[str, Any]] = Field(default_factory=list, description="List of medications (e.g., {'name': 'MedX', 'dosage': '10mg'})")
    allergies: list[str] = Field(default_factory=list, description="List of allergies")
    allergies_sensitivities: str | None = Field(None, description="Detailed allergies and sensitivities text") # if different from list
    problem_list: str | None = Field(None, description="Patient's problem list text")
    primary_care_physician: str | None = Field(None, description="Patient's primary care physician details")
    pharmacy_information: str | None = Field(None, description="Patient's preferred pharmacy details")
    care_team_contact_info: str | None = Field(None, description="Care team contact information text")
    ...
    confidential_information_lve: str | None = Field(None, description="Confidential information (LVE)")
