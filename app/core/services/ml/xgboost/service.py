...
class XGBoostService(MLServiceInterface):
    ...
    async def get_model_info(self, model_type: str) -> dict[str, Any]:
        ...
        return {
            ...
            "output_types": ["risk_scores", "treatment_response", "symptom_forecast"],
        }
    ...
    async def healthcheck(self) -> dict[str, Any]:
        ...
        return {
            "status": "healthy",
            "model_load_status": {"xgboost": "loaded", "mental_health": "ready"},
            "dependencies": {"cuda": "available", "memory": "sufficient"},
        }
