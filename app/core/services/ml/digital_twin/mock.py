...
class MockDigitalTwinService(DigitalTwinInterface):  # Corrected base class
        ...
        try:
            if not config or not isinstance(config, dict):
                raise InvalidConfigurationError(
                    "Invalid configuration: must be a non-empty dictionary"
                )
            ...
            self._config = None
            raise InvalidConfigurationError(
                f"Failed to initialize mock Digital Twin service: {e!s}"
            )
    ...
    def create_session(
        self, patient_id: str, context: dict[str, Any] | None = None, **kwargs
    ) -> dict[str, Any]:
        """
    ...
    def get_session(self, session_id: str, **kwargs) -> dict[str, Any]:
        """
    ...
    def send_message(self, session_id: str, message: str, **kwargs) -> dict[str, Any]:
        """
    ...
    def end_session(self, session_id: str, **kwargs) -> dict[str, Any]:
        """
    ...
    def _generate_all_insights(
        self, patient_id: str, time_period: str | None = None
    ) -> dict[str, Any]:
        """
    ...
    def _generate_sleep_insights(
        ...
        return {
            ...
            "data": {
                ...
                "average_hours": round(
                    sum(item["hours"] for item in sleep_data) / len(sleep_data), 1
                ),
    ...
    def _generate_medication_insights(
        self, patient_id: str, time_period: str | None = None
    ) -> dict[str, Any]:
        """
        ...
        for i in range(days):
            ...
            day_data = {"date": date, "medications": {}}
    ...
    def _generate_treatment_insights(
        ...
        return {
            ...
            "data": {
                ...
                "treatment_modules": [
                    {"name": "CBT Module 1", "completion": 100, "feedback_score": 4.5},
                    {"name": "CBT Module 2", "completion": 75, "feedback_score": 4.2},
                    {"name": "Mindfulness", "completion": 50, "feedback_score": 4.0},
                ],
                "observations": [
