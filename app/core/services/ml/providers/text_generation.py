...
class TextGenerationService(TextGenerationInterface):
    ...
    def is_healthy(self) -> bool:
        ...
        return (
            self._initialized
            and self._mentalllama_service is not None
            and self._mentalllama_service.is_healthy()
        )
    ...
    def generate_text(
        ...
        **kwargs,
        ...
        llama_context = self._prepare_context(
            sanitized_prompt, sanitized_context, model_config.get("system_prompt", "")
        )
    ...
    def _prepare_context(
        self, prompt: str, context: str | None, system_prompt: str
    ) -> dict[str, Any]:
        """
        ...
        return {"messages": messages, "format": "chat"}
