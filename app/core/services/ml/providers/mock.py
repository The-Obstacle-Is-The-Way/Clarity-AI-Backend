...
class MockMentaLLaMA(MentaLLaMAInterface):
        ...
        try:
            if "provider" not in config:
                raise InvalidConfigurationError(
                    "Missing required configuration parameter: provider"
                )

            if config["provider"] != "mock":
                raise InvalidConfigurationError(
                    f"Invalid provider: {config['provider']}. Expected: mock"
                )
    ...
    def detect_depression(
        ...
        if (
            "very depressed" in text_lower
            or "don't enjoy anything" in text_lower
            or ("depressed" in text_lower and "hopeless" in text_lower)
        ):
    ...
    def _initialize_provider(self) -> None:
        ...
        try:
            ...
            self._available_models = {
                ...
                "mock-clinical": {
                    "provider": "mock",
                    "capabilities": ["clinical", "depression_detection"],
                },
                "mock-risk": {
                    "provider": "mock",
                    "capabilities": ["clinical", "risk_assessment"],
                },
                "mock-advanced": {
                    "provider": "mock",
                    "capabilities": [
    ...
    def _setup_mock_responses(self) -> None:
        ...
        self._depression_detection_responses = {
            ...
            "mild": {
                "depression_indicated": True,
                "key_indicators": ["occasional sadness", "mild fatigue"],
                "severity": "mild",
        ...
        self._risk_assessment_responses = {
            ...
            "low_risk": {
                "risk_level": "low",
                "key_indicators": ["occasional hopelessness", "mild distress"],
                "suggested_actions": [
                    "Routine follow-up",
        ...
        self._wellness_dimensions_responses = {
            "balanced": {
                ...
                "areas_of_strength": ["intellectual", "physical", "emotional"],
                "areas_for_improvement": ["spiritual", "social"],
                "recommendations": [
            ...
            "unbalanced": {
                ...
                "areas_of_strength": ["occupational", "intellectual"],
                "areas_for_improvement": ["emotional", "social", "physical"],
                "recommendations": [
