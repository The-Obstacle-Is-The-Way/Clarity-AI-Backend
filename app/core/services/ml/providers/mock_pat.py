...
class MockPAT(PATInterface):
    ...
    def detect_anomalies(
        ...
        **kwargs,
        ...
        for _ in range(num_anomalies):
            ...
            if readings:
                timestamp = readings[random.randint(0, len(readings) - 1)].get(
    ...
    def integrate_with_digital_twin(
        ...
        **kwargs,
        ...
        logger.info(
            f"Mock integrating actigraphy analysis with digital twin for patient {patient_id}"
        )
            ...
            "clinical_implications": {
                "depression_risk": {
                    ...
                    "contributing_factors": [
                        ...
                        {
                            "factor": "activity_reduction",
                            "weight": random.uniform(0.3, 0.9),
                        },
                        {
                            "factor": "circadian_disruption",
                            "weight": random.uniform(0.3, 0.9),
                        },
                    ],
                },
