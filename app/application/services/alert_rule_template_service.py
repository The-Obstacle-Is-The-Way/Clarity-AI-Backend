...
class AlertRuleTemplateService(AlertRuleTemplateServiceInterface):
    ...
    async def apply_template(
        ...
        if not template:
            ...
            raise ApplicationError(code=ErrorCode.NOT_FOUND, message=error_msg)
        ...
        try:
            ...
            rule_data = {
                ...
                "priority": customization.get(
                    "priority", template_dict.get("default_priority", "medium")
                ),
                "logical_operator": customization.get(
                    "logical_operator", template_dict.get("logical_operator", "and")
                ),
            }
            ...
            for template_condition in template_conditions:
                ...
                condition = {
                    ...
                    "comparator_operator": template_condition.get(
