...
class BiometricAlertRuleService:
        ...
        try:
            ...
            for template_condition in template.conditions:
                ...
                condition = RuleCondition(
                    ...
                    threshold_value=condition_overrides.get("threshold_value", template_condition.threshold_value),
                    description=condition_overrides.get("description", template_condition.description)
                )
    ...
    async def create_rule(self, rule_data: dict[str, Any]) -> BiometricAlertRule:
        ...
        try:
            ...
            logical_operator = (
                RuleLogicalOperator.AND if logical_op_str == "and" 
        ...
        try:
            ...
            if "logical_operator" in update_data:
                ...
                existing_rule.logical_operator = (
                    RuleLogicalOperator.AND if op_str == "and"
                    else RuleLogicalOperator.OR
                )
