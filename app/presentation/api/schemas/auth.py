...
class UserRegistrationResponseSchema(BaseModel):
    ...
    is_active: bool = Field(
        ...,
        description="Whether the user account is active (usually True after registration)",
    )
    is_verified: bool = Field(
        False,
        description="Whether the user's email has been verified (usually False initially)",
    )
