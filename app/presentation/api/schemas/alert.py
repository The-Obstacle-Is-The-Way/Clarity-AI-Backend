...
class AlertRuleBase(BaseModelConfig):
    ...
    priority: RuleAlertPriority = Field(
        RuleAlertPriority.MEDIUM, description="Priority of alerts generated by this rule"
    )
    ...
    logical_operator: LogicalOperator = Field(
        LogicalOperator.AND, description="Logical operator combining conditions (AND/OR)"
    )
