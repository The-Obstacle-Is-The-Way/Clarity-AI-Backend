...
async def predict_risk(
    ...
    try:
        ...
        raise HTTPException(status_code=status.HTTP_503_SERVICE_UNAVAILABLE, detail="Failed to connect to prediction service")
...
async def simulate_digital_twin(
    ...
    try:
        ...
        raise HTTPException(status_code=status.HTTP_503_SERVICE_UNAVAILABLE, detail="Failed to connect to simulation service")
    except Exception as e:
