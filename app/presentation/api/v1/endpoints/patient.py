...
This module defines the API endpoints for managing patient resources, including CRUD operations
...
async def read_patient(
    ...
    """
    logger.info(f"Endpoint read_patient called for patient_id: {patient_id}")
...
async def create_patient(
    ...
    Returns:
        Newly created patient data with ID
    """
    logger.info("Endpoint create_patient called")
    created_patient = await service.create_patient(patient_data)
    
    # Return the created patient with appropriate response model
...
async def update_patient(
    ...
    updated_patient = await service.update_patient(patient_id, patient_data)
