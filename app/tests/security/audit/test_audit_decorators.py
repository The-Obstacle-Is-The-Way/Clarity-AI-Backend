...
from app.infrastructure.logging.audit import (
    audit_phi_access, audit_async_phi_access, 
    set_current_user, get_current_user_id, get_current_access_reason, 
    clear_current_user
)
...
class TestAuditDecorators:
    ...
    def test_audit_phi_access_without_user_context(self):
        ...
        with patch('app.infrastructure.logging.audit.get_audit_logger') as mock_get_logger:
            ...
            # Define a test function with the decorator
            @audit_phi_access(resource_type="patient", action="view", default_reason="system_operation")
