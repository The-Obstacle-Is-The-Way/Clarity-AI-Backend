...
class TestXGBoostIntegration:
    ...
    async def test_risk_prediction_flow(self, client: AsyncClient, 
        ...
        # Don't assert on specific ID values that might be generated by the endpoint
    ...
    async def test_outcome_prediction(self, client: AsyncClient,
        ...
        # Configure mock return value for predict_outcome as a dictionary
        # Including the required expected_outcomes field required by OutcomePredictionResponse
        ...
        mock_service.predict_outcome.assert_called_once_with(
            ...
            clinical_data={},  # Default empty dict from the handler
            treatment_plan={}  # Default empty dict from the handler
        )
