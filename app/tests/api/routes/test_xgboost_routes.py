    ...
    def mock_model_info_data(request: ModelInfoRequest):
        ...
        return ModelInfoResponse(
            ...
            performance_metrics=PerformanceMetrics(
                accuracy=0.88, precision=0.85, recall=0.82, f1_score=0.83, auc_roc=0.92
            ),
    ...
    [
        (
            ...
            RiskPredictionRequest(
                ...
                clinical_data={"diagnosis": "depression", "duration_months": 6},
            ),
            RiskPredictionResponse(
                ...
                risk_level="high",
                risk_score=0.75,
                risk_factors={"previous_attempts": 0.3, "symptom_severity": 0.5},
                confidence=0.85,
        ...
        (
            ...
            TreatmentResponseResponse(
                ...
                side_effect_risk=SideEffectRisk(common=[], rare=[]),
                features={
                    "age": 25,
                    "gender": "female",
                    "diagnosis": "depression",
                ...
                treatment_features={"therapy_type": "CBT", "frequency": "weekly"},
...
def test_xgboost_endpoints_return_200(client, endpoint, request_model, response_model):
    ...
    ), f"Endpoint {endpoint} returned {response.status_code} instead of 200"
...
def test_xgboost_risk_prediction_with_invalid_data(client):
    ...
    ), "Endpoint accepted invalid data without validation error"

    error_detail = response.json()["detail"]
    # Validation error should mention missing required patient_id field
    assert any(
        "patient_id" in error["loc"] for error in error_detail
