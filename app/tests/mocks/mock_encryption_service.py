...
class MockEncryptionService(BaseEncryptionService):
    ...
    def __init__(self, key: str = "mock_test_key", previous_key: str | None = None):
    ...
    def encrypt_dict(
        self, data: dict[str, Any], encrypt_keys: list[str] | None = None
    ) -> dict[str, Any]:
        """
    ...
    def decrypt_dict(
        self, data: dict[str, Any], decrypt_keys: list[str] | None = None
    ) -> dict[str, Any]:
        """
    ...
    def _looks_encrypted(self, value: str | bytes) -> bool:
    ...
    def decrypt_string(self, value: str | bytes | None) -> str | None:
        """
        ...
        try:
            ...
            logger.error(f"String decryption failed in mock: {e!s}")
            raise ValueError(f"Mock string decryption failed: {e!s}")
