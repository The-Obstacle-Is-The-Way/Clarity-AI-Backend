...
class AnalyticsEventResponse(BaseModel):
    ...
    timestamp: datetime = Field(
        ..., description="When the event occurred", examples=["2025-03-30T12:00:00Z"]
    )
...
class AnalyticsAggregateResponse(BaseModel):
    ...
    dimensions: dict[str, Any] = Field(
        ...
        examples=[
            {"event_type": "page_view"},
            {"user_role": "provider", "date": "2025-03-30"},
        ],
    )
    ...
    time_period: dict[str, datetime] | None = Field(
        None, description="Optional time range for this aggregate"
    )
...
class AnalyticsAggregatesListResponse(BaseModel):
    ...
    generated_at: datetime = Field(..., description="When this result was generated")
            ...
            "example": {
                "aggregates": [
                    ...
                    },
                    {
                        ...
                        "metrics": {"count": {"value": 80, "type": "integer"}},
                    },
                ],
                "total_count": 2,
                "query_info": {
