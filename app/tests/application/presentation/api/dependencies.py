...
from app.infrastructure.persistence.sqlalchemy.unit_of_work_factory import (
    UnitOfWorkFactory,
)
...
_unit_of_work_factory = UnitOfWorkFactory(session_factory=async_session_factory)
...
def get_digital_twin_repository(
...
def get_digital_twin_service(
    repository: SQLAlchemyDigitalTwinRepository = Depends(get_digital_twin_repository),
) -> DigitalTwinService:
    """
