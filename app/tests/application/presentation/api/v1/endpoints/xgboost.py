...
async def predict_risk(
    ...
    try:
        ...
        logger.info(f"XGBoostService instance in predict_risk: {xgboost_service.__class__.__name__}")
...
async def predict_outcome(
    ...
    try:
        ...
        result = xgboost_service.predict_outcome(
            ...
            social_determinants=request.social_determinants if hasattr(request, 'social_determinants') else None,
