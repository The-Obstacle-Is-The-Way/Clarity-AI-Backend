...
def mock_boto3(mocker, request):
    ...
    # mock_client = mocker.patch("app.core.services.ml.pat.aws.boto3.client") # INCORRECT TARGET & Unused by tests below
    ...
    #         # Return the dedicated comprehend mock if available via request param
    #         if 'mock_comprehend_medical_client' in request.fixturenames:
    #             return request.getfixturevalue('mock_comprehend_medical_client')
    #         return mock_comprehend_instance # Fallback generic
    #     else:
    ...
    #         return mock_dynamodb_table_instance
...
#     )
#     service.initialize(aws_config) # Ensure service is initialized
#     return service
