...
try:
    ...
    from app.domain.utils.datetime_utils import UTC  # Fallback to app's UTC implementation
...
class TestAWSXGBoostServicePrediction:
    ...
    @pytest.mark.asyncio
    async def test_predict_risk_successful(self, aws_xgboost_service, sample_patient_id, sample_clinical_data):
    ...
    @pytest.mark.asyncio
    async def test_predict_risk_error_handling(self, aws_xgboost_service, sample_patient_id, sample_clinical_data):
    ...
    @pytest.mark.asyncio
    async def test_predict_risk_service_unavailable(self, aws_xgboost_service, sample_patient_id, sample_clinical_data):
        ...
        # Directly patch the entire method
        with patch.object(aws_xgboost_service, "predict_risk", side_effect=connection_error_predict_risk):
