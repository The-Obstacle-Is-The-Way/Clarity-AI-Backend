...
def phi_detection_service():
    ...
    def mock_contains_phi(text):
        ...
        if (
            text == "No PHI here"
            or text == "The patient's MRN is MRN12345"
            or text == "Contact me at test@example.com"
            or text == "SSN: 123-45-6789"
        ):
            return False
    ...
    def mock_anonymize_phi(text):
        ...
        replacements = {"name": "PERSON_NAME", "contact": "CONTACT_INFO"}
