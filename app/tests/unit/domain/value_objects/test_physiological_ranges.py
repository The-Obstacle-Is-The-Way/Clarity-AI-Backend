...
class TestPhysiologicalRange:
    ...
    def test_init_with_valid_values(self) -> None:
        ...
        with pytest.raises(ValueError) as excinfo:
            PhysiologicalRange(min=100.0, max=60.0, critical_min=40.0, critical_max=140.0)
        ...
        with pytest.raises(ValueError) as excinfo:
            PhysiologicalRange(min=60.0, max=100.0, critical_min=70.0, critical_max=140.0)
        ...
        with pytest.raises(ValueError) as excinfo:
            PhysiologicalRange(min=60.0, max=100.0, critical_min=40.0, critical_max=90.0)
