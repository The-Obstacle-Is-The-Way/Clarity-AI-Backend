...
class TestContactInfo:
    ...
    def test_create_with_optional_fields(self):
        ...
        contact_info = ContactInfo(phone="555-123-4567")
    ...
    def test_to_dict(self, valid_contact_info):
        ...
        contact_info_with_none = ContactInfo(email="test@example.com", phone=None)
    ...
    def test_create_secure_contact_info_factory(self):
        ...
        contact_info = create_secure_contact_info(
            email="test@example.com", phone="555-123-4567", preferred_method="email"
        )
...
@patch(
    "app.infrastructure.security.encryption.base_encryption_service.BaseEncryptionService.encrypt"
)
@patch(
    "app.infrastructure.security.encryption.base_encryption_service.BaseEncryptionService.decrypt"
)
class TestContactInfoEncryption:
    ...
    def test_encryption(self, mock_decrypt, mock_encrypt):
        ...
        contact_info = ContactInfo(email=None, phone=None)
    ...
    def test_decryption(self, mock_decrypt, mock_encrypt):
        ...
        # Test with None values
        contact_info = ContactInfo(email=None, phone=None, _is_encrypted=True)
        ...
        contact_info = ContactInfo(
            email="test@example.com", phone="555-123-4567", _is_encrypted=False
        )
    ...
    def test_get_encryption_service(self, mock_decrypt, mock_encrypt):
        ...
        with patch(
            "app.domain.value_objects.contact_info.get_encryption_service"
        ) as mock_get_service:
...
class Patient:
    ...
    def __init__(self, email=None, phone=None):
        ...
        self._contact_info = ContactInfo(email=email, phone=phone)
