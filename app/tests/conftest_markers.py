...
def pytest_configure(config):
    ...
    config.addinivalue_line("markers", "flaky: Tests with occasional failures that are being investigated")
    config.addinivalue_line("markers", "smoke: Critical functionality tests used for rapid verification")
