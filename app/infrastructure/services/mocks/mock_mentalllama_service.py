...
class MockMentalLLaMAService(MentalLLaMAService):
    ...
    async def analyze_clinical_notes(
        self, patient_id: UUID, note_text: str, context: dict | None = None
    ...
    async def analyze_risk_factors(
        ...
        for diagnosis in diagnoses:
            ...
            if (
                diag_code.startswith("F32")
                or diag_code.startswith("F33")
                or "depression" in diag_name
            ):
