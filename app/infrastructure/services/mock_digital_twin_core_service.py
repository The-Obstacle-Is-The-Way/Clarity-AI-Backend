...
class MockDigitalTwinCoreService:
    ...
    async def process_treatment_event(
        ...
        state_id = uuid4()
        new_state = type('DigitalTwinState', (), {
            'id': state_id,
            'patient_id': patient_id,
    ...
    async def generate_treatment_recommendations(
        ...
        if include_therapy_options:
            recommendations.append({
                ...
                "confidence": 0.9,
                "expected_outcomes": ["reduced rumination", "improved coping strategies"]
            })
    ...
    async def compare_states(
        ...
        return {
            ...
            "state_2": {
                "id": str(state_id_2),
                "timestamp": "2025-05-14T15:05:00Z"
            },
            "brain_state_changes": {
                "serotonin": {
                    "before": 0.7, 
