...
class AWSComprehendMedicalPHIDetection(PHIDetectionInterface):
    ...
    def initialize(self, config: dict[str, Any]) -> None:
        ...
        try:
            ...
            try:
                self._comprehend_medical_service = (
                    self._aws_service_factory.get_comprehend_medical_service()
                )
                ...
                logger.error(
                    f"Failed to get Comprehend Medical service from factory: {factory_error!s}"
                )
    ...
    def detect_phi(self, text: str) -> list[dict[str, Any]]:
        ...
        try:
            ...
            audit_details = {
                ...
                "phi_types": list(set(entity["type"] for entity in entities_list))
                if entities_list
                else [],
