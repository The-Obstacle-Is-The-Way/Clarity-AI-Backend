...
class MockDigitalTwinService(DigitalTwinInterface):
    ...
    def initialize(self, config: dict[str, Any]) -> None:
        ...
        if "invalid" in config:
            raise InvalidConfigurationError(
                "Invalid configuration: contains reserved 'invalid' key"
            )
    ...
    def get_twin_status(self, twin_id: str) -> dict[str, Any]:
        ...
        return {
            ...
            "patient_id": twin.get("patient_id"),
        }
    ...
    def send_message(self, session_id: str, message: str) -> dict[str, Any]:
        ...
        exact_message_responses = {
            "I've been feeling so hopeless lately.": "I hear you're feeling hopeless, which can be a sign of depression. Let's discuss ways to address these feelings.",
            "I'm constantly worried about everything.": "I understand you're experiencing anxiety. Let's explore what might be triggering these feelings.",
            "I'm not sure if my medication is working.": "Let's discuss your medication effectiveness. Have you noticed any changes in your symptoms since starting this medication?",
            "I haven't been sleeping well.": "Sleep issues can affect your overall well-being. Let's talk about your sleep patterns and possible improvements.",
            "I've started walking every day.": "Regular exercise like walking is excellent for both physical and mental wellness. How has this exercise routine been affecting your mood?",
        }
        ...
        if message in exact_message_responses:
            ...
            if "hopeless" in message.lower():
                ...
                "walking" in message.lower()
                or "wellness" in message.lower()
                or "exercise" in message.lower()
            ):
                topic = "wellness"
            ...
            if any(x in msg_lower for x in ["hello", "hi", "hey", "greetings"]):
                ...
                "i've been feeling so hopeless" in msg_lower
                or "hopeless" in msg_lower
                or "sad" in msg_lower
    ...
    def get_insights(
        ...
        insights = {
            ...
            "treatment": {
                "effectiveness_assessment": random.choice(
                    [
                        "very effective",
                        "effective",
    ...
    def _generate_specific_insight(
        self, insight_type: str, daily_values: list, time_period: str
    ) -> dict:
            ...
            observations.append(
                {
                    ...
                    "created_at": format_iso8601(
                        now_utc() - datetime.timedelta(days=random.randint(0, 7))
                    ),
                }
            )
        ...
        return {
            "type": insight_type,
            "data": {"summary": f"Mock insight for {insight_type}"},
        }
