...
from app.infrastructure.persistence.sqlalchemy.types.encrypted_types import (
    EncryptedJSON, EncryptedString, EncryptedText
)
...
class PatientModel(Base):
    ...
    def from_domain(cls, patient: Patient) -> 'PatientModel':
        ...
        emergency_contact_dict = patient.emergency_contact.to_dict() if patient.emergency_contact else None
    ...
    def to_domain(self) -> Patient:
        ...
        emergency_contact_obj = EmergencyContact(**self.emergency_contact) if self.emergency_contact else None
