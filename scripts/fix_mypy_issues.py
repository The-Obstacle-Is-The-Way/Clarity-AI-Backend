...
def run_mypy(path: Optional[str] = None) -> Tuple[int, str]:
...
def main():
    ...
    parser.add_argument(
        "--report-only", 
        action="store_true",
        help="Generate a report without fixing issues"
    )
    parser.add_argument(
        "--fix-returns", 
        action="store_true",
        help="Fix missing return type annotations"
    )
    parser.add_argument(
        "--fix-params", 
        action="store_true",
        help="Fix missing parameter type annotations"
    )
    parser.add_argument(
        "--fix-all", 
        action="store_true",
        help="Fix all supported typing issues"
    )
